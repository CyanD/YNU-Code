...
public class BusRouteLazy implements java.io.Serializable {
	...
	/** minimal constructor */
	public BusRouteLazy(String name, String startStation, String endStation,
...
//		this.busSchedules = busSchedules;
	...
	/*@Transactional
	@OneToMany(cascade = CascadeType.DETACH, fetch = FetchType.LAZY, mappedBy = "busRoute")
