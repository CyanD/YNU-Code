...
public class AddressbookDepartmentTreeGrid implements java.io.Serializable {

	public AddressbookDepartmentTreeGrid(Long id, Long _parentId, String name,
	...
	public AddressbookDepartmentTreeGrid() {
	}
	@Id
	@GeneratedValue
