...
public class NewsNewsCategoryTreeGridSet implements java.io.Serializable {

	// Fields

	public NewsNewsCategoryTreeGridSet(Long id, Long _parentId, String name,
	...
	/** default constructor */
	public NewsNewsCategoryTreeGridSet() {
	}
