...
public class StudentFieldKind implements java.io.Serializable {
	...
	/** default constructor */
	public StudentFieldKind() {
	}

	/** minimal constructor */
	public StudentFieldKind(Long id, Long _parentId, String name, String createTime, String publisher) {
		this.id = id;
