...
@Component("addressbookDeptAction")
@Scope("prototype")
public class AddressbookDeptAction extends SuperAction implements ModelDriven<AddressbookDeptVO>{
	...
	public String show() throws Exception {
		vo.setIsSystem("否");
		vo.setQueryString("where isSystem = '否' ");
		print(vo);
		try {
