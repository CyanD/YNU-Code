...
public class T9GUI extends JFrame {
	...
	private void initializeButtons() {
		...
		button4 = new JButton("4 GHI");
		button5 = new JButton("5 JKL");
		button6 = new JButton("6 MNO");
		button7 = new JButton("7 PQRS");
		button8 = new JButton("8 TUV");
		button9 = new JButton("9 WXYZ");
