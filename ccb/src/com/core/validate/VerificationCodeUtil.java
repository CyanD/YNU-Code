...
public class VerificationCodeUtil {   
    ...
    private VerificationCodeUtil() {   
        ...
        if (randomNum == 0) {   
            initNumVerificationCode(bufImage);   
        } else if (randomNum == 1) {   
            initLetterAndNumVerificationCode(bufImage);   
        } else {   
            initChinesePlusNumVerificationCode(bufImage);   
        }   
    }   
    ...
    public void initChinesePlusNumVerificationCode(BufferedImage image) {   
        ...
        g.setFont(new Font("宋体", Font.PLAIN, 14));// 设定字体   
